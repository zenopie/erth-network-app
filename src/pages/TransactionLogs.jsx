        ...
        <>
          ...
          <div className={styles.logsContent}>
            ...
            {logs.length > 0 && (
              <>
                ...
                <table className={styles.logsTable}>
                  ...
                  <tbody>
                    {logs.map((log, index) => (
                      <tr key={`valid-${index}`} onClick={() => handleRowClick(log)} className={styles.clickableRow}>
            ...
            {invalidLogs.length > 0 && (
              <>
                <h3>Invalid Logs</h3>
                <table className={`${styles.logsTable} ${styles.invalidLogsTable}`}>
                  <thead>
                    <tr>
                      <th>Time</th>
                      <th>User Address</th>
                  ...
                  <tbody>
                    {invalidLogs.map((log, index) => (
                      <tr key={`invalid-${index}`} onClick={() => handleRowClick(log)} className={styles.clickableRow}>
          ...
          {selectedLog && (
            <div className={styles.logModalOverlay} onClick={closeModal}>
